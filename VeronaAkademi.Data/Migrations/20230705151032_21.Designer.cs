...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VeronaAkademi.Data.LecturerAdvisorRelation", b =>
                {
                    b.Property<int>("LecturerAdvisorRelationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LecturerAdvisorRelationId"));
                    ...
                    b.HasKey("LecturerAdvisorRelationId");

                    b.HasIndex("AdvisorId");

                    b.HasIndex("LecturerId");

                    b.ToTable("LecturerAdvisorRelation");
                });
            ...
            modelBuilder.Entity("VeronaAkademi.Data.LecturerAdvisorRelation", b =>
                {
                    b.HasOne("VeronaAkademi.Data.Entities.Advisor", "Advisor")
                        .WithMany("LecturerAdvisorRelation")
                        .HasForeignKey("AdvisorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VeronaAkademi.Data.Entities.Advisor", b =>
                {
                    b.Navigation("LecturerAdvisorRelation");
