// Global Her yerde geçerli validation.Js, İstenen inputun class'ına required eklenmeli; eğer özel mesaj isteniyorsa feedback="" özelliği içine yazılmalı.
// Sonrasında Ajax Gönderilmeden validation fonksiyonu çağrılır ve şartların sağlanıp sağlanmadığına bakılır.
// telefon ve email maskelemesi için type="email" type="tel" şeklinde yazılmalıdır, required class'ına gerek yoktur.
