            ...
            if ($('.rbt-cart-sidenav-activation').length) {
                $('.rbt-cart-sidenav-activation').on('click', function (e) {
                    ...
                    if (tip == "sepet") {
                        ...
                        Post("/courseui/SideBarLesson",
                            { id: id },
                            function (response) {
                                $(".rbt-cart-side-menu").empty().html(response);
                            },
                            function (x, y, z) {
                                //Error
                            },
                    ...
                    $(document).on('click', '.minicart-close-button', function (e) {
                        $('.rbt-cart-side-menu').removeClass('side-menu-active'),
                            $('body').removeClass('cart-sidenav-menu-active')
                    }),

                    $(document).on('click', '.side-menu .side-nav .navbar-nav li a', function (e) {
                        $('.rbt-cart-side-menu').removeClass('side-menu-active'),
                            $('body').removeClass('cart-sidenav-menu-active')
                    }),

                    $(document).on('click', '#btn_sideNavClose, .close_side_menu', function (e) {
                        $('.rbt-cart-side-menu').removeClass('side-menu-active'),
                            $('body').removeClass('cart-sidenav-menu-active')
                    });
            }
