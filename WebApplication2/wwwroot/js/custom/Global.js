var Global = function () {
    ...
    $(document).on("click", "[event='BaseDurum']", function (e) {
        e.preventDefault();
    ...
    $(document).on("click", "#PagerTopluSil", function (e) {
        e.preventDefault();
        var url = $(this).attr("url");
        deleteAll(url);
    });

    $(document).on("click", "#PagerTopluAktif", function (e) {
        e.preventDefault();
        var url = $(this).attr("url");
        activeAll(url);
    });

    $(document).on("click", "#PagerTopluPasif", function (e) {
        e.preventDefault();
        var url = $(this).attr("url");
        passiveAll(url);
    });
    ...
    function kaydet(formId, ValidationFieldColumns, url, serializeOptions) {
                ...
                bootbox.dialog({
                    ...
                    buttons: {
                        ...
                        ok: {
                            ...
                            className: 'btn-info',
                            callback: function () {
                                kaydet(formId, validationFields, kayitUrl);
                                return false;
                            }
                        }
                    }
    ...
    return {
        ...
        Kaydet: function (formId, ValidationFieldColumns, url, serializeOptions) {
            kaydet(formId, ValidationFieldColumns, url, serializeOptions);
        },
